...
MODEL_URLS = {
    ...
    "VGG16": "https://api.ngc.nvidia.com/v2/models/nvidia/research/stylegan3/versions/1/files/metrics/vgg16.pkl"
}
...
class MetricOptions:
    def __init__(self, num_gpus=1, rank=0, device=None, progress=None, cache=True, run_dir=None, cur_nimg=None,
                 snapshot_pkl=None):
